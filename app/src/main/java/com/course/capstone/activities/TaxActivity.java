...
public class TaxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tax.add(new EducationCard(R.drawable.tax_1,"과세소득","소득세의 부과 대상이 되는 소득, 전체 소득 중에서 과세대상이 되지 않는 비과세 소득 및 면세 소득이외의 모든 소득을 말한다."));
        Tax.add(new EducationCard(R.drawable.tax_1,"갑근세","갑종근로소득으로 분류된 소득에 대하여 부과되는 조세입니다. "));
        Tax.add(new EducationCard(R.drawable.tax_1,"지방세","지방자치단체가 당해 지방자치단체의 재정수요에 충당하기 위하여 주민에게 부과,징수하는 조세를 말한다."));
        ...
        Tax.add(new EducationCard(R.drawable.tax_1,"보통징수","지방세의 징수 방법중 하나로 세무공무원이 납세고지서를 납세자에게 발급하여 지방세를 징수하는 것을 말한다."));
        Tax.add(new EducationCard(R.drawable.tax_1,"과세주체","세금을 매기는 주체로 국가나 지방 자치 단체를 말한다."));
        Tax.add(new EducationCard(R.drawable.tax_1,"결정세액","산출세액에서 세액고제액과 감면세액을 공제한 금액을 말한다."));
        Tax.add(new EducationCard(R.drawable.tax_1,"인지세","재산상의 권리를 표시하는 증서를 대상으로 작성자에게 부과하는 세금.\n" +
        ...
        Tax.add(new EducationCard(R.drawable.tax_1,"지방소득세","국세의 부가세 일부를 지방세로 돌려 활용하는 것으로 지자체의 재정자립도를 높이려는 목적으로 도입이 시도 되고 있는 세금이다.\n"+
