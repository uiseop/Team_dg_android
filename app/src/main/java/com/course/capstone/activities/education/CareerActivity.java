...
public class CareerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (Button) findViewById(R.id.button_career1);
        button2 = (Button) findViewById(R.id.button_career2);
        button3 = (Button) findViewById(R.id.button_career3);
        button4 = (Button) findViewById(R.id.button_career4);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("category1", "금융진로");
